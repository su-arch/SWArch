valid_countries = {"Argentina", "Australia", "Austria", "Belgium", "Brazil", "Canada", "Chile", "Costa Rica",
...
valid_provinces = {'Australia': {'NSW', 'NT', 'QLD', 'SA', 'TAS', 'VIC', 'WA'},
...
alphanumeric_postcodes = {'Argentina', 'Canada', 'Great Britain', 'Ireland',
                          'Isle of Man', 'Northern Ireland', 'Scotland', 'Netherlands'}

valid_postcodes = {"Argentina": [8], "Australia": [4], "Austria": [4], "Belgium": [4],
...
required_fields = {"Argentina": standard,
...
opt_fields = {"Argentina": floor + department,
                   "Australia": street2,
                   "Brazil": district,
                   "Canada": apt,
                   "Costa Rica": floor,
