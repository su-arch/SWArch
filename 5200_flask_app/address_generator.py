...
import itertools
from app.validations import expand_from_schema, collapse_to_schema
...
if __name__ == '__main__':
    ...
    for i in range(1000):
        ...
        print(address)
        collapsed_addr = collapse_to_schema(address)
    ...
    for input in inputs:
        ...
        input['_id'] = random.randint(1, 9999999999)
        input = json.dumps(input)
        res = expand_from_schema(input)
